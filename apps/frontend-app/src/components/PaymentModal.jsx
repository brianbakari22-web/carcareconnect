...
function PaymentModal({ booking, amount, onSuccess, onCancel }) {
  ...
  const handleCardPayment = async () => {
    ...
    try {
      ...
      const intentRes = await fetch('https://carcareconnect-backend.onrender.com/api/payments/create-intent', {
        method: 'POST',
        headers: {
      ...
      const confirmRes = await fetch('https://carcareconnect-backend.onrender.com/api/payments/confirm', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
  ...
  const handleCashPayment = async () => {
    ...
    try {
      const res = await fetch('https://carcareconnect-backend.onrender.com/api/payments/cash', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': `Bearer ${token}`
